...
from schedules.models import ImmediateEvent
...
# ---------
from tokenizer.models import Tokenizer
...
class User(models.Model):
    ...
    image_thumbnail = ImageSpecField(source='imageURL', id='enhueco:thumbnail')
    ...
    immediate_event_updated_on = models.DateTimeField(default=timezone.now)
    ...
    requests_sent = models.ManyToManyField('self', through='FriendRequest', symmetrical=False,
