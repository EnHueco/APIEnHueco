...
class GapTestCase(TestCase):
    ...
    def test_gap_cross_different_days(self):
        gap1 = Gap(day="1",start_hour='090',end_hour='130')
        gap2 = Gap(day="2",start_hour='090',end_hour='130')
    ...
    def test_gap_cross_not_overlapping(self):
        ...
        gap1 = Gap(day="1",start_hour='090',end_hour='130')
        gap2 = Gap(day="1",start_hour='140',end_hour='153')
    ...
    def test_gap_cross_overlapping_case_1(self):
        ...
        """
        gap1 = Gap(day="1",start_hour='083',end_hour='113')
        gap2 = Gap(day="1",start_hour='100',end_hour='130')
        sharedGap = gap1.cross(gap2)
    ...
    def test_gap_cross_overlapping_case_2(self):
        ...
        """
        gap1 = Gap(day="1",start_hour='083',end_hour='153')
        gap2 = Gap(day="1",start_hour='100',end_hour='130')
        sharedGap = gap1.cross(gap2)
    ...
    def test_gap_cross_overlapping_case_3(self):
        ...
        """
        gap1 = Gap(day="1",start_hour='100',end_hour='170')
        gap2 = Gap(day="1",start_hour='100',end_hour='170')
        sharedGap = gap1.cross(gap2)
